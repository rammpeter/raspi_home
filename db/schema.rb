...
ActiveRecord::Schema.define(version: 2016_06_15_000000) do
  ...
  create_table "konfigurations", force: :cascade do |t|
    ...
    t.index ["created_at"], name: "index_konfigurations_on_created_at"
  end
  ...
  create_table "temperaturs", force: :cascade do |t|
    ...
    t.index ["created_at"], name: "index_temperaturs_on_created_at"
  end
